...
def get_rates_by_period(start_date, end_date, base=None):
    ...
    """
    date_mask = "%Y-%m-%d"
    end_date = datetime.datetime.strptime(end_date, date_mask)
    start_date = datetime.datetime.strptime(start_date, date_mask)
...
rates = get_rates_by_period("2014-12-12", "2017-02-02", "EUR")
